...
function VideoDetailsSidebar({ setReviewModal }) {
    ...
    useEffect(() => {
        (() => {
            ...
            const activeSubSectionIndex = courseSectionData[currentSectionIndex].subSection[currentSubSectionIndex]._id
            setActiveStatus(courseSectionData[currentSectionIndex]._id)
            setVideoBarActive(activeSubSectionIndex)
        })()
                            ...
                            >
                                <div className='flex flex-row justify-between bg-richblack-600 px-5 py-4'>
                                    ...
                                    <div className='flex items-center gap-3'>
                                        <span
                                            className={`${activeStatus === course?.sectionName ? "rotate-0" : "rotate-100"} transition-all duration-500`}
                                        >
                                            <BsChevronDown />
                                        </span>
                                    </div>
